...
\begin{center}
  ...
  \begin{flushleft}
    \begin{multicols}{2}
      ...
      {\textbf{Other:}} metric learning, reinforcement learning, transformers, CNNs, GANs, Linux, Git, GCP, Docker \\ % LaTeX
    ...
    \begin{compactitem}
      \itemsep0em
      \item Created a library of epidemiological models, datasets, and other tools for forecasting COVID-19 and seasonal flu cases. %, under the direction of Prof. Naren Ramakrishnan and funded by a NSF REU Supplement.
    ...
    \begin{compactitem}
      ...
      %\item A publication based on these results is currently under review.
    \end{compactitem}
    ...
    \begin{compactitem}
      ...
      %\item Currently preparing a first-author manuscript for submission in Fall 2022.
    ...
    {\large\textbf{\underline{\smash{Publications}}}} \\
    \begin{compactitem}
      \itemsep0em
    ...
    %{\large\textbf{\underline{\smash{Coursework}}}} \\
    %\textbf{Movie Neural Style Transfer} - For th
