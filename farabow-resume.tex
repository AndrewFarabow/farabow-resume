...
\begin{document}
  ...
  \begin{flushleft}
    ...
    \textbf{Research Assistant - Hume Center (Virginia Tech) \hfill 2019 - present (school year)}
    \begin{itemize}
      \itemsep0em
      \item Working under Prof. Daniel Doyle to train reinforcement learning agents on strategy games. 
      \item Previously designed and trained object-detecting convolutional neural network architectures for drone navigation
    \end{itemize}

    \textbf{Research Assistant - BIST (Virginia Tech) \hfill 2019 - present (school year)}
    \begin{itemize}
      \itemsep0em
