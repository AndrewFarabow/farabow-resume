...
\begin{center}
  ...
  \begin{flushleft}
    \begin{multicols}{2}
      ...
      {\textbf{Other:}} deep learning, RNNs, CNNs, metric learning, reinforcement learning, GANs, autoencoders, data analytics, Linux, Git, AWS, GCP, Docker, Agile/Scrum \\ % LaTeX
    ...
    \begin{compactitem}
      \itemsep0em
      \item Developing a few-shot ship-recognition algorithm using deep metric learning.
    \end{compactitem}
