...
\begin{center}
  ...
  \begin{flushleft}
    ...
    \begin{compactitem}
      \itemsep0em
      \item Worked on a small team to develop Sense, a product that uses deep reinforcement learning to control the resources allocated to a microservice, striking a balance between server performance and hosting cost (predictive autoscaling).
