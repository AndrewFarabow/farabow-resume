...
\begin{center}
  ...
  \begin{flushleft}
    ...
    \begin{compactitem}
      \itemsep0em
      \item Developing a RNN model to contribute influenza case forecasts to the CDC FluSight Competition.
      \item Spearheading the effort to create an open-source library of epidemiological models for forecasting the COVID-19 pandemic and the seasonal flu, under the direction of Prof. Naren Ramakrishnan with NSF REU Supplement funding.
    ...
    \begin{compactitem}
      ...
      \item Currently preparing a manuscript for submission sometime in Summer 2022.
    \end{compactitem}
